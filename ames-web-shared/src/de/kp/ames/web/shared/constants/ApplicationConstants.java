...
public class ApplicationConstants {
	...
	/*
	 * Classification of chat application
	 */
	public static String FNC_APP_ID_Chat = FNC_ID_App + ":Chat";	
	/*
	...
	/*
	 * Classification of mail application
	 */
	public static String FNC_APP_ID_Mail = FNC_ID_App + ":Mail";	
	/*
